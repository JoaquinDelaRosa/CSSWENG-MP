...
const all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    order_1.Order.find({})
        ...
        .then((data) => {
        res.json({ data: order_2.makeOrderArrayView(data), count: count ? count : 0 });
    });
});
const id = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    order_1.Order.findOne({ _id: req.query.id })
        ...
        .populate("vehicle")
        .then((data) => {
        res.json(order_2.makeOrderView(data));
    });
});
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    order_1.Order.create(Object.assign(Object.assign({}, req.body), { _id: crypto_1.randomUUID() }), (error, result) => {
        console.log(error);
        return result;
    });
    res.json(req.body);
