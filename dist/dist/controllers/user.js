...
const all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user_1.User.find({})
        ...
        .then((data) => {
        res.json({ data: user_2.makeUserArrayView(data), count: count ? count : 0 });
    });
});
const id = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    user_1.User.findOne({ _id: req.query.id })
        .then((data) => {
        res.json(user_2.makeUserView(data));
    });
});
...
const filter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user_1.User.find(makeMongooseQuery(query))
        ...
        .limit(parseInt(req.query.limit))
        .then((result) => {
        res.json({ data: user_2.makeUserArrayView(result), count: count ? count : 0 });
        res.end();
    }).catch((err) => {
        console.log(err);
        res.end();
