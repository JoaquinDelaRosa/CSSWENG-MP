        ...
        <>
            <div className="licensePlateTag">
                ...
                <input className="vehicleSubField"
                    {... register('licensePlate', {
                        required: true, 
                        pattern: isLicensePlate
                    })}
                    type="text" 
                    name="licensePlate" 
                    defaultValue={props.default?.licensePlate}/>
            ...
            <div className="manufactTag">
                ...
                <input className="vehicleSubField"
                    ...
                    type="text" 
                    name="manufacturer" 
                    defaultValue={props.default?.manufacturer}/>
            ...
            <div className="modelTag">
                ...
                <input className="vehicleSubField"
                    ...
                    type="text" 
                    name="model" 
                    defaultValue={props.default?.model}/>
            ...
            <div className="yearManufTag">
                ...
                <select  className="vehicleSubField" {...register('yearManufactured', {
                    valueAsNumber: true, 
                    required: true, 
                    validate: {
                        isValid : (v : any) => {
                    ...
                    defaultValue= {(props.default && props.default.yearManufactured) ? props.default.yearManufactured.valueOf():  {DEFAULT}}
                >
